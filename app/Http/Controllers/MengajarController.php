...
class MengajarController extends Controller
{
    ...
    public function destroy(Mengajar $mengajar)
    {
        ...
        if($nilai) {
            return back()->with('error', "$mengajar->guru->nama_guru masih digunakan di menu mengajar");
        }
        
        $mengajar->delete();

        return redirect('/mengajar/index')->with('success', 'Nama Kelas berhasil dihapus');
    }
}
